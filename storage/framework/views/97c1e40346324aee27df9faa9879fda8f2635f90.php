    ...
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-gray-200 text-center border border-gray-300 px-8 py-6 rounded">
            <h3 class="text-gray-700 uppercase font-bold">
                ...
                <span class="leading-tight">Satellites</span>
            </h3>
        </div>
...
</div><?php /**PATH C:\Users\KKariuki\Desktop\Studentmanagement\College-System-Laravel\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>