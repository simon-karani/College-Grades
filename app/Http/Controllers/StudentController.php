...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        $students = Student::with('class')->orderBy('parent_id','desc')->orderBy('class_id')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('backend.students.create', compact('classes','parents','subjects'));
    }
    ...
    public function edit(Student $student)
    {
        ...
        return view('backend.students.edit', compact('classes','parents'));
    }
